...
try:
    query = cte_sql + f'''SELECT oco.numero_ocorrencia as "Número REDS",
               ...
               AND vei.situacao_placa_descricao_longa = 'ROUBADO'
...
caminho_excel = (
    ...
    f"XLSX - Uso interno/"
    f"Veiculos - Roubo - Jan 2015 a {datas.mes_ref_abrev} {datas.ano_ref}.xlsx"
)
...
caminho_csv = (
    ...
    f"{datas.mes_ref_num_str} - {datas.mes_ref_abrev}/"
    f"CSV -Uso externo/"
    f"Veiculos - Roubo - Jan 2015 a {datas.mes_ref_abrev} {datas.ano_ref}.csv"
)
