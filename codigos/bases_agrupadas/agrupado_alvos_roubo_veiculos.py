...
# Ordenar pelas colunas "Ano Fato", "Mês", "Município" e "Natureza"
    df = df.sort_values(
    by=["Ano Fato", "Mês", "Município", "Natureza"],
...
df.to_excel("C:/Users/x15501492/Documents/02 - Publicações/11 - Publicação SESP - Site/2026/02 - Fevereiro/Excel/agrupado_roubo_veiculos.xlsx",index=False)
...
base_excel = "C:/Users/x15501492/Documents/02 - Publicações/11 - Publicação SESP - Site/2026/02 - Fevereiro/Excel/agrupado_roubo_veiculos.xlsx"

# 1️⃣ Lê as bases
df_excel = pd.read_excel(base_excel)

# Caminho CSV
caminho_csv = "C:/Users/x15501492/Documents/02 - Publicações/11 - Publicação SESP - Site/2026/02 - Fevereiro/Banco de Dados CSV/Banco Veículos Roubados - Atualizado Fevereiro 2026.csv"
