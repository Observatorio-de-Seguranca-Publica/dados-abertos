...
try:
    query = '''         WITH 
                        ...
                        periodos as (
                            ...
                            AND oco.data_hora_fato < '2019-01-01 00:00:00.000' 
                        ),
                        naturezas AS (
                            SELECT DISTINCT
                                oco.natureza_codigo,
...
df.to_excel("C:/Users/x15501492/Documents/02 - Publicações/11 - Publicação SESP - Site/2026/02 - Fevereiro/Excel/12_18_agrupado_crimes_violentos.xlsx",index=False)
...
base_excel = "C:/Users/x15501492/Documents/02 - Publicações/11 - Publicação SESP - Site/2026/02 - Fevereiro/Excel/12_18_agrupado_crimes_violentos.xlsx"

# 1️⃣ Lê as bases
df_excel = pd.read_excel(base_excel)

# Caminho CSV
caminho_csv = "C:/Users/x15501492/Documents/02 - Publicações/11 - Publicação SESP - Site/2026/02 - Fevereiro/Banco de Dados CSV/Banco Crimes Violentos 2012 a 2018 - Atualizado Fevereiro 2026.csv"
